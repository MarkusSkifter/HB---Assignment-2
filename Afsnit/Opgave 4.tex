...
We use the undiscounted sum as the primary measure because it represents the government's actual cumulative tax intake over the life cycle --- the total amount of resources collected regardless of when they arrive. As a robustness check, discounting each period's revenue by $\beta^t = 0.98^t$ gives a present value of the budget change of 1{,}592.3, which is still a large positive number. This confirms that the revenue gain is not driven by a few late periods but is present throughout the life cycle, and the conclusion is robust to the choice of discounting.
