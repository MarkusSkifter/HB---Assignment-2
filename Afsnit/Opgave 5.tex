...
\begin{figure}[H]
    ...
    \caption{Budget difference $\Delta G(\lambda^{\text{indiv}})$ as a function of the individual tax scale. The dashed line marks budget neutrality ($\Delta G = 0$). The root at $\lambda^{\text{indiv},\star} \approx 1.767$ is where the individual scheme collects the same revenue as the joint scheme.}
